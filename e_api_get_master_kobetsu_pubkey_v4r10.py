...
#
# 必要な設定項目
# 取得するマスター項目:     S_TARGET_CLMID  対象機能ＩＤ
...
# S_TARGET_CLMID = 'CLMStkGetIssueMstKabu'         # 株式 銘柄マスタ
# S_TARGET_CLMID = 'CLMStkGetIssueSizyouMstKabu'   # 株式 銘柄市場マスタ
S_TARGET_CLMID = 'CLMStkGetIssueMstSak'          # 先物
# S_TARGET_CLMID = 'CLMStkGetIssueMstOp'           # ＯＰ
# S_TARGET_CLMID = 'CLMIssueMstOther'        # 指数、為替、その他
# S_TARGET_CLMID = 'CLMStkGetOrderErrReason'       # 取引所エラー理由コード
# S_TARGET_CLMID = 'CLMStkGetDateZyouhou'          # 日付情報
...
#        マスタデータ識別子：			※１								
#        CLMStkGetIssueMstKabu    	銘柄マスタ_株					
#        CLMStkGetIssueSizyouMstKabu	銘柄市場マスタ_株					
#        CLMStkGetIssueMstSak	    	銘柄マスタ_先物					
#        CLMStkGetIssueMstOp	    	銘柄マスタ_ＯＰ					
#        CLMIssueMstOther   	日経平均等指数、為替、その他上記外の銘柄コードと名称					
#        CLMStkGetOrderErrReason  	取引所エラー理由コード					※３
...
# # 機能: 銘柄マスタ_株（CLMStkGetIssueMstKabu）用 sTargetColumn作成 
# # 引数: 無し
# # 返値: 取得フィールド名 string型
# def func_make_column_CLMStkGetIssueMstKabu():
...
# def func_make_column_CLMStkGetIssueSizyouMstKabu():
#     str_column = 'sIssueCode'
...
# def func_make_column_CLMStkGetIssueMstSak():
#     str_column = 'sIssueCode'
#     str_column = str_column + ',' + 'sIssueName'
#     str_column = str_column + ',' + 'sIssueNameEizi'
...
# def func_make_column_CLMStkGetIssueMstOp():
...
# def func_make_column_CLMStkGetDaiyouKakeme():
...
# def func_make_column_CLMStkGetHosyoukinMst():
#     str_column = 'sSystemKouzaKubun'
#     str_column = str_column + ',' + 'sIssueCode'
#     str_column = str_column + ',' + 'sZyouzyouSizyou'
...
# def func_make_column_CLMStkGetDateZyouhou():
#     str_column = 'sDayKey'
...
# def func_make_column_CLMStkGetOrderErrReason():
...
# def func_make_column_CLMStkGetYobine():
...
#         str_sTargetColumn = func_make_column_CLMStkGetIssueMstKabu()
        
#     elif str_sTargetCLMID == 'CLMStkGetIssueSizyouMstKabu' :
#         str_sTargetColumn = func_make_column_CLMStkGetIssueSizyouMstKabu()
        
#     elif str_sTargetCLMID == 'CLMStkGetIssueMstSak' :
#         str_sTargetColumn = func_make_column_CLMStkGetIssueMstSak()
        
#     elif str_sTargetCLMID == 'CLMStkGetIssueMstOp' :
#         str_sTargetColumn = func_make_column_CLMStkGetIssueMstOp()
...
#         str_sTargetColumn = func_make_column_CLMStkGetDaiyouKakeme()
        
#     elif str_sTargetCLMID == 'CLMStkGetHosyoukinMst' :
#         str_sTargetColumn = func_make_column_CLMStkGetHosyoukinMst()
        
#     elif str_sTargetCLMID == 'CLMStkGetDateZyouhou' :
#         str_sTargetColumn = func_make_column_CLMStkGetDateZyouhou()
        
#     elif str_sTargetCLMID == 'CLMStkGetOrderErrReason' :
#         str_sTargetColumn = func_make_column_CLMStkGetOrderErrReason()
...
#         str_sTargetColumn = func_make_column_CLMStkGetYobine()
